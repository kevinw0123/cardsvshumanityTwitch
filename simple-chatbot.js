...
chatClient.prototype.buildLeaderboard = function buildLeaderboard(){
    ...
    for(var i = 0; i < 10; i++){
        ...
        template.find('.user-points').text(this.gameObject.highscore[viewerName]);
